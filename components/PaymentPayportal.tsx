...
import { MONITORED_FIELDS, subcribePayportalTrans } from "@/lib/client/appwriteUserPPTransSub";  
...
const PaymentPayportal = ({ searchParams }: PaymentPayportalProps) => {  
  ...
  const currentPortal = (Array.isArray(portalParam) ? portalParam[0] : portalParam) || "zalopay";  
